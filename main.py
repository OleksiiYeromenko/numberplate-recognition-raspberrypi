...
def main(weights, img_size, det_conf_thres, log_level,cam_rotate_180, show_img, save_img, display_img):
    # Init instances
    ...
    while True:
        ...
        if show_img or save_img or display_img:
            visualizer = Visualize(im0=detect_result['orig_img'], file_name=detect_result['file_name'],
                                   ...
                                   out_img_size=(720, 1280), outp_orig_img_size=720, log_dir='./logs/',
